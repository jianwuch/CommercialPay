...
public class Y_DividerBuilder {
    ...
    public Y_DividerBuilder setLeftSideLine(boolean isHave, @ColorInt int color, float widthDp,
            float startPaddingDp, float endPaddingDp) {
        this.leftSideLine = new Y_SideLine(isHave, color, widthDp, startPaddingDp, endPaddingDp);
        return this;
    }

    public Y_DividerBuilder setTopSideLine(boolean isHave, @ColorInt int color, float widthDp,
            float startPaddingDp, float endPaddingDp) {
        this.topSideLine = new Y_SideLine(isHave, color, widthDp, startPaddingDp, endPaddingDp);
        return this;
    }

    public Y_DividerBuilder setRightSideLine(boolean isHave, @ColorInt int color, float widthDp,
            float startPaddingDp, float endPaddingDp) {
        this.rightSideLine = new Y_SideLine(isHave, color, widthDp, startPaddingDp, endPaddingDp);
        return this;
    }

    public Y_DividerBuilder setBottomSideLine(boolean isHave, @ColorInt int color, float widthDp,
            float startPaddingDp, float endPaddingDp) {
